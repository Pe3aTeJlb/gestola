...
export abstract class SerialDevice {
    protected _onData: Emitter<string> = new Emitter<string>();
    public readonly onData: Event<string> = this._onData.event;

    protected _onEnd: Emitter<void> = new Emitter<void>();
