...
} from 'react-chart-editor/lib/shame';
...
import {categoryLayout, traceTypes} from 'react-chart-editor/lib/lib/traceTypes';
import {ModalProvider} from 'react-chart-editor/lib/components/containers';
...
class EditorControls extends Component {
  ...
  handleUpdate({type, payload}) {
    const graphDiv = this.props.selectedGraphDiv;
    ...
    switch (type) {
      ...
      case EDITOR_ACTIONS.MOVE_TO:
        ...
        if (payload.path && !isNaN(payload.fromIndex) && !isNaN(payload.toIndex)) {
          ...
          if (this.props.onUpdate) {
            this.props.onUpdate(graphDiv.id, updatedData, updatedLayout, graphDiv._transitionData._frames);
          }
        }
        break;
...
EditorControls.propTypes = {
  ...
  selectedGraphDiv: PropTypes.object,
  locale: PropTypes.string,
  onUpdate: PropTypes.func,
  onAddWidget: PropTypes.func,
  onRemoveWidget: PropTypes.func,
  onCollectWidgets: PropTypes.func,
