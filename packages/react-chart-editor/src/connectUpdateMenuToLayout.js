...
import {getDisplayName} from 'react-chart-editor/lib/lib';
...
export default function connectUpdateMenuToLayout(WrappedComponent) {
  class UpdateMenuConnectedComponent extends Component {
    constructor(props, context) {
      ...
      this.deleteUpdateMenu = this.deleteUpdateMenu.bind(this);
    ...
    getChildContext() {
      return {
        ...
        deleteContainer: this.deleteUpdateMenu,
    ...
    deleteUpdateMenu() {
      if (this.context.onUpdate) {
        this.context.onUpdate({
          type: ADDITIONAL_EDITOR_ACTIONS.DELETE_CONTROL,
          payload: {
